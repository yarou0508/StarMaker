...
#%% ===================================LSTM with pre-trained word embedding model============================= 
...
class LSTM:    
    def __init__(self, vocab_size, batch_size, 
        ...
        with tf.device('/cpu:0'):
            # initialize the input, target data with placeholder
            ...
            # Load in the pre-trained the word embedding matrix by skip-gram method
